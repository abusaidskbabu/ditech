...
use App\Models\Aboutourself;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class AboutourselfController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'aboutourself';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Aboutourself();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'aboutourself',
	...
	public static function display(  )
	{
		...
		$model  = new Aboutourself();
		$info = $model::makeInfo('aboutourself');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('aboutourself.public.view',$data);			
			}			
		} 
		else {
			...
			return view('aboutourself.public.index',$data);	
		}
