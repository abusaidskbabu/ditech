...
use App\Models\Ourindustry;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class OurindustryController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ourindustry';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourindustry();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourindustry',
	...
	public static function display(  )
	{
		...
		$model  = new Ourindustry();
		$info = $model::makeInfo('ourindustry');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourindustry.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourindustry.public.index',$data);	
		}
