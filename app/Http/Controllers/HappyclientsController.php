...
class HappyclientsController extends Controller {
	...
	public $module = 'happyclients';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Happyclients();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'happyclients',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('happyclients');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('happyclients.public.view',$data);			
			}			
		} 
		else {
			...
			return view('happyclients.public.index',$data);	
		}
