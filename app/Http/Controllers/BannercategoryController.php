...
class BannercategoryController extends Controller {
	...
	public $module = 'bannercategory';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Bannercategory();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'bannercategory',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('bannercategory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('bannercategory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('bannercategory.public.index',$data);	
		}
