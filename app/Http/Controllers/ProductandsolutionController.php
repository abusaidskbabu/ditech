...
use App\Models\Productandsolution;
...
class ProductandsolutionController extends Controller {
	...
	public $module = 'productandsolution';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Productandsolution();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'productandsolution',
	...
	public static function display(  )
	{
		...
		$model  = new Productandsolution();
		$info = $model::makeInfo('productandsolution');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('productandsolution.public.view',$data);			
			}			
		} 
		else {
			...
			return view('productandsolution.public.index',$data);	
		}
