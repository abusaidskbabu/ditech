...
class CompanysectionpostController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'companysectionpost';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Companysectionpost();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'companysectionpost',
	...
	public static function display(  )
	{
		...
		$model  = new Companysectionpost();
		$info = $model::makeInfo('companysectionpost');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('companysectionpost.public.view',$data);			
			}			
		} 
		else {
			...
			return view('companysectionpost.public.index',$data);	
		}
