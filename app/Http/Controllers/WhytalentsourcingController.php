...
use App\Models\Whytalentsourcing;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class WhytalentsourcingController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'whytalentsourcing';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Whytalentsourcing();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'whytalentsourcing',
	...
	public static function display(  )
	{
		...
		$model  = new Whytalentsourcing();
		$info = $model::makeInfo('whytalentsourcing');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('whytalentsourcing.public.view',$data);			
			}			
		} 
		else {
			...
			return view('whytalentsourcing.public.index',$data);	
		}
