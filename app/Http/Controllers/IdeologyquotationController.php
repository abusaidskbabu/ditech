...
use App\Models\Ideologyquotation;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class IdeologyquotationController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ideologyquotation';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ideologyquotation();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ideologyquotation',
	...
	public static function display(  )
	{
		...
		$model  = new Ideologyquotation();
		$info = $model::makeInfo('ideologyquotation');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ideologyquotation.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ideologyquotation.public.index',$data);	
		}
