...
class ProfessionalaffiliationController extends Controller {
	...
	public $module = 'professionalaffiliation';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Professionalaffiliation();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'professionalaffiliation',
	...
	public static function display(  )
	{
		...
		$model  = new Professionalaffiliation();
		$info = $model::makeInfo('professionalaffiliation');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('professionalaffiliation.public.view',$data);			
			}			
		} 
		else {
			...
			return view('professionalaffiliation.public.index',$data);	
		}
