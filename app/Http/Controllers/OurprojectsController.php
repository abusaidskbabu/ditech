...
class OurprojectsController extends Controller {
	...
	public $module = 'ourprojects';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourprojects();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourprojects',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('ourprojects');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourprojects.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourprojects.public.index',$data);	
		}
