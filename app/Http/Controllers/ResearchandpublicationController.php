...
use App\Models\Researchandpublication;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ResearchandpublicationController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'researchandpublication';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Researchandpublication();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'researchandpublication',
	...
	public static function display(  )
	{
		...
		$model  = new Researchandpublication();
		$info = $model::makeInfo('researchandpublication');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('researchandpublication.public.view',$data);			
			}			
		} 
		else {
			...
			return view('researchandpublication.public.index',$data);	
		}
