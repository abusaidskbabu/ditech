...
class UnderattackrequestController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'underattackrequest';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Underattackrequest();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'underattackrequest',
	...
	public static function display(  )
	{
		...
		$model  = new Underattackrequest();
		$info = $model::makeInfo('underattackrequest');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('underattackrequest.public.view',$data);			
			}			
		} 
		else {
			...
			return view('underattackrequest.public.index',$data);	
		}
