...
use App\Models\Parliamentaryforum;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ParliamentaryforumController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'parliamentaryforum';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Parliamentaryforum();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'parliamentaryforum',
	...
	public static function display(  )
	{
		...
		$model  = new Parliamentaryforum();
		$info = $model::makeInfo('parliamentaryforum');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('parliamentaryforum.public.view',$data);			
			}			
		} 
		else {
			...
			return view('parliamentaryforum.public.index',$data);	
		}
