...
use App\Models\Ourcompanysection;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class OurcompanysectionController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ourcompanysection';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourcompanysection();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourcompanysection',
	...
	public static function display(  )
	{
		...
		$model  = new Ourcompanysection();
		$info = $model::makeInfo('ourcompanysection');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourcompanysection.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourcompanysection.public.index',$data);	
		}
