...
class OurvaluesController extends Controller {
	...
	public $module = 'ourvalues';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourvalues();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourvalues',
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourvalues.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourvalues.public.index',$data);	
		}
