...
use App\Models\Mycareerhistory;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class MycareerhistoryController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'mycareerhistory';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Mycareerhistory();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'mycareerhistory',
	...
	public static function display(  )
	{
		...
		$model  = new Mycareerhistory();
		$info = $model::makeInfo('mycareerhistory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('mycareerhistory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('mycareerhistory.public.index',$data);	
		}
