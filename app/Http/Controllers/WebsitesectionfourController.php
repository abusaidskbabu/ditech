...
use App\Models\Websitesectionfour;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class WebsitesectionfourController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'websitesectionfour';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Websitesectionfour();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'websitesectionfour',
	...
	public static function display(  )
	{
		...
		$model  = new Websitesectionfour();
		$info = $model::makeInfo('websitesectionfour');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('websitesectionfour.public.view',$data);			
			}			
		} 
		else {
			...
			return view('websitesectionfour.public.index',$data);	
		}
