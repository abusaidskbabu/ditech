...
class ContactrequestController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('contactrequest');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('contactrequest.public.view',$data);			
			}			
		} 
		else {
			...
			return view('contactrequest.public.index',$data);	
		}
