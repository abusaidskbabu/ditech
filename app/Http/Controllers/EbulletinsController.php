...
class EbulletinsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ebulletins';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ebulletins();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ebulletins',
	...
	public static function display(  )
	{
		...
		$model  = new Ebulletins();
		$info = $model::makeInfo('ebulletins');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ebulletins.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ebulletins.public.index',$data);	
		}
