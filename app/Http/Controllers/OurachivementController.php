...
class OurachivementController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ourachivement';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourachivement();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourachivement',
	...
	public static function display(  )
	{
		...
		$model  = new Ourachivement();
		$info = $model::makeInfo('ourachivement');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourachivement.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourachivement.public.index',$data);	
		}
