...
class MypublicationsController extends Controller {
	...
	public $module = 'mypublications';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Mypublications();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'mypublications',
	...
	public static function display(  )
	{
		...
		$model  = new Mypublications();
		$info = $model::makeInfo('mypublications');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('mypublications.public.view',$data);			
			}			
		} 
		else {
			...
			return view('mypublications.public.index',$data);	
		}
