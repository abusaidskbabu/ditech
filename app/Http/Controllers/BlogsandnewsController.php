...
class BlogsandnewsController extends Controller {
	...
	public $module = 'blogsandnews';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Blogsandnews();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'blogsandnews',
	...
	public static function display(  )
	{
		...
		$model  = new Blogsandnews();
		$info = $model::makeInfo('blogsandnews');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('blogsandnews.public.view',$data);			
			}			
		} 
		else {
			...
			return view('blogsandnews.public.index',$data);	
		}
