...
use App\Models\Respectforhonesty;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class RespectforhonestyController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'respectforhonesty';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Respectforhonesty();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'respectforhonesty',
	...
	public static function display(  )
	{
		...
		$model  = new Respectforhonesty();
		$info = $model::makeInfo('respectforhonesty');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('respectforhonesty.public.view',$data);			
			}			
		} 
		else {
			...
			return view('respectforhonesty.public.index',$data);	
		}
