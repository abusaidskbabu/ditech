...
class CasestudiessectionController extends Controller {
	...
	public $module = 'casestudiessection';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Casestudiessection();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'casestudiessection',
	...
	public static function display(  )
	{
		...
		$model  = new Casestudiessection();
		$info = $model::makeInfo('casestudiessection');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('casestudiessection.public.view',$data);			
			}			
		} 
		else {
			...
			return view('casestudiessection.public.index',$data);	
		}
