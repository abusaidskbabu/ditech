...
class BannersliderController extends Controller {
	...
	public $module = 'bannerslider';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Bannerslider();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'bannerslider',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('bannerslider');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('bannerslider.public.view',$data);			
			}			
		} 
		else {
			...
			return view('bannerslider.public.index',$data);	
		}
