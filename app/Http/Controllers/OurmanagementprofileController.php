...
use App\Models\Ourmanagementprofile;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class OurmanagementprofileController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ourmanagementprofile';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourmanagementprofile();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourmanagementprofile',
	...
	public static function display(  )
	{
		...
		$model  = new Ourmanagementprofile();
		$info = $model::makeInfo('ourmanagementprofile');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourmanagementprofile.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourmanagementprofile.public.index',$data);	
		}
