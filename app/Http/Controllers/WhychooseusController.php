...
class WhychooseusController extends Controller {
	...
	public $module = 'whychooseus';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Whychooseus();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'whychooseus',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('whychooseus');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('whychooseus.public.view',$data);			
			}			
		} 
		else {
			...
			return view('whychooseus.public.index',$data);	
		}
