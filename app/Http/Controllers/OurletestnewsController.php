...
use App\Models\Ourletestnews;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class OurletestnewsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ourletestnews';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourletestnews();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourletestnews',
	...
	public static function display(  )
	{
		...
		$model  = new Ourletestnews();
		$info = $model::makeInfo('ourletestnews');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourletestnews.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourletestnews.public.index',$data);	
		}
