...
class RolecategoryController extends Controller {
	...
	public $module = 'rolecategory';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Rolecategory();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'rolecategory',
	...
	public static function display(  )
	{
		...
		$model  = new Rolecategory();
		$info = $model::makeInfo('rolecategory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('rolecategory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('rolecategory.public.index',$data);	
		}
