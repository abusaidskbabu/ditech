				...
				{!! Form::hidden('id', $row['id']) !!}					
						...
						required     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Image" class=" control-label col-md-4 text-left">
										    <p style="color:#f00; font-size:12px;">(Image Size: W:600px X H:400px )</p>
										</label>
										<div class="col-md-6">
						...
						<div class="image-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["image"],"/uploads/images/media") !!}
									  ...
									  <div class="form-group row  " >
										<label for="Icon Image" class=" control-label col-md-4 text-left"> Icon Image 
										<p style="color:#f00; font-size:12px;">(Image Size: W:25px X H:20px )</p>
										</label>
										<div class="col-md-6">
						...
						required     class='form-control form-control-sm ' /> 
				           ...
				           >{{ $row['short_description'] }}</textarea> 
									  ...
									  </div> {!! Form::hidden('description', $row['description']) !!}{!! Form::hidden('add_info', $row['add_info']) !!}					
									  <div class="form-group row  " >
