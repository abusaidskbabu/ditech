...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'vacancy?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="col-md-12">
				...
				{!! Form::hidden('id', $row['id']) !!}					
						...
						<div class="banner-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["banner"],"/uploads/images/circular") !!}
						</div>
				...
				<div class="input-group input-group-sm m-b" style="width:150px !important;">
					{!! Form::text('post_end_date', $row['post_end_date'],array('class'=>'form-control form-control-sm datetime')) !!}
					<div class="input-group-append">
					 	<div class="input-group-text"><i class="fa fa-calendar"></i></span></div>
					 </div>
				</div>
									  ...
									  </div> {!! Form::hidden('appointment_date', $row['appointment_date']) !!}					
									  <div class="form-group row  " >
						 ...
						 >{{ $row['description'] }}</textarea> 
									  ...
									  <div class="form-group row  " >
										<label for="Vacancy" class=" control-label col-md-4 text-left"> Vacancy </label>
										<div class="col-md-6">
										  <input  type='text' name='vacancy' id='vacancy' value='{{ $row['vacancy'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										<label for="Employment Tatus" class=" control-label col-md-4 text-left"> Employment Tatus </label>
										<div class="col-md-6">
										  <input  type='text' name='employment_tatus' id='employment_tatus' value='{{ $row['employment_tatus'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Job Location" class=" control-label col-md-4 text-left"> Job Location </label>
										<div class="col-md-6">
										  <input  type='text' name='job_location' id='job_location' value='{{ $row['job_location'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										<label for="Salary" class=" control-label col-md-4 text-left"> Salary </label>
										<div class="col-md-6">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#status").jCombo("{!! url('vacancy/comboselect?filter=status:id:title') !!}",
		{  selected_value : '{{ $row["status"] }}' });
		 	
		 	 

		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("vacancy/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
