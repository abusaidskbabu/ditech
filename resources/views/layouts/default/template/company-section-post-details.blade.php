        		...
        		<div id="hero_slider_carousel" class="owl-carousel owl-theme">
              		<div class="item active ">
              			<div class="repeated-css bg-sapphire-medium">
              				<img src="{{url('/')}}/uploads/images/company-section-post/{{ $single->image }}?pq=medium" class="slide-image hidden-xs">
              				<img class="slide-image visible-xs" src="{{url('/')}}/uploads/images/company-section-post/{{ $single->image }}?pq=low" >
              			</div>
		    ...
		    <div class="row mb50">
		      <div class="grid-do_more col-md-12 col-sm-12 col-xs-12 wow fadeInUp" data-wow-delay="0.3s">
		      	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-xs-20"> 
		      		<img src="{{url('/')}}/uploads/images/company-section-post/{{ $single->image }}" class="img-responsive text-center" />
		      	</div>
		        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-xs-20">
		        	{!! $single->details !!}
		        </div>
