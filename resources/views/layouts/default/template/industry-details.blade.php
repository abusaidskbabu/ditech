	              				...
	              				<div class="container">
	              					<div class="row">
	                    				<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
						                    <h2 class="h2-heading white-color mb-xs-10">{{ $industry->title }}</h2>
	                    				</div>
	              					</div>
	              				</div>
	              			</div>
  		...
  		<article class="container relative">
    		<div class="row">
	      		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center wow fadeInUp" data-wow-delay="0.1s"> 
	        		...
	        		<h2 class="h2-heading">{{ $industry->title }}</h2>
      			</div>
    		</div>
		    <div class="row mb50">
		      <div class="grid-do_more col-md-12 col-sm-12 col-xs-12 wow fadeInUp" data-wow-delay="0.3s">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-xs-20" style="text-align: -webkit-center;">
					<img src="{{url('/')}}/uploads/images/industry/{{ $industry->image }}" alt="" class="img-responsive">
				</div>
  		...
  		<article class="container relative">
    		<div class="row">
	      		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center wow fadeInUp" data-wow-delay="0.3s"> 
	      			<img src="{{ asset('assets') }}/images/18/vertical-line.png" alt="" />
	        		<h2 class="h2-heading text-capitalize">Services of {{ $title }} Industry</h2>
