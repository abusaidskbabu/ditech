...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'ourprojects?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
				...
				{!! Form::hidden('id', $row['id']) !!}					
						...
						required     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='icon' id='icon' value='{{ $row['icon'] }}'  class='form-control form-control-sm ' placeholder='<i class="fa fa-graduation-cap" aria-hidden="true">'/>
										  <span style="color:#456;">Get icon From <a target="_blank" href="https://fontawesome.com/v4.7.0/icons/">here</a> </span>
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("ourprojects/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
