	...
	<div class="col-md-12">
				...
				{!! Form::hidden('id', $row['id']) !!}					
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <textarea name='question' rows='5' id='question' class='form-control form-control-sm '  
				           >{{ $row['question'] }}</textarea> 
									  ...
									  <div class="form-group row  " >
										<label for="Ans" class=" control-label col-md-4 text-left"> Ans </label>
										<div class="col-md-6">
										  <textarea name='ans' rows='5' id='ans' class='form-control form-control-sm '  
				           >{{ $row['ans'] }}</textarea> 
										 </div> 
										 <div class="col-md-2">
