		 ...
		 {!! Form::open(array('url'=>'parliamentaryforum', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
						<fieldset><legend> Parliamentary Forum for Health</legend>
				{!! Form::hidden('id', $row['id']) !!}					
						...
						<div class="image-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["image"],"/uploads/images/forum") !!}
						</div>
					...
					$category_opt = array( 'advisors' => 'Advisors' ,  'chairman' => 'Chairman' ,  'co_chairmen' => 'Co-Chairmen' ,  'members' => 'Members' , ); ?>
