...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'parliamentaryforum?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
				...
				{!! Form::hidden('id', $row['id']) !!}					
						...
						required     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										...
										<p style="color:#f00; font-size:12px;">(Image Size: W:220px X H:220px )</p>
										</label>
										<div class="col-md-6">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("parliamentaryforum/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
